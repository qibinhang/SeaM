...
class CifarResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, is_reengineering=False):
...
def _resnet(
    ...
    **kwargs: Any
    ...
    model = CifarResNet(BasicBlock, layers, is_reengineering=is_reengineering, **kwargs)
    if pretrained:
...
if __name__ == '__main__':
    resnet20_model = cifar10_resnet20(pretrained=True)
    print(resnet20_model)